...
def traintest_BSERGB_x5AdamwithLPIPS(args):
    ...
    paths.save = ED()
    paths.save.save_path = './x5_interpolation_hardcoding'
    ...
    training_config.losses.ECharbonier.emask_type = "flag"
    training_config.losses.ECharbonier.weight = 0.5
    training_config.losses.ECharbonier.as_loss = False
